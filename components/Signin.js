...
function Signin(){
    const { googleLogHandler} = useContext(authContext);
    return (
        <main className='container max-w-2xl px-6 mx-auto'>
            ...
            <div className='flex flex-col overflow-hidden shadow-md shadow-slate-500 bg-slate-800 rounded-2xl'>
                ...
                px-4 py-4'>
                    ...
                    className='flex self-start gap-2 p-4 mx-auto mt-6 font-medium text-white align-middle bg-gray-700 rounded-lg' > <FcGoogle className='text-2xl'/> Google</button>
                </div>
            </div>
        </main>
    )
